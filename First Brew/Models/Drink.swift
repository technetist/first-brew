...
let drinkData = [
    ...
    Drink(id: UUID().uuidString, name: "Americano", imageName: "americano", category: Category.hot, description: "An Americano Coffee is an Espresso-based coffee drink with no special additions. It is simply a shot of Espresso with hot water poured in it. A well-prepared Americano has the subtle aroma and flavor like Espresso. It has a lighter body and less bitterness.", price: 2.00),
    ...
    Drink(id: UUID().uuidString, name: "Cold Brew", imageName: "cold brew", category: Category.filter, description: "Cold brew is as simple as mixing ground coffee with cool water and steeping the mixture in the fridge overnight.", price: 2.50),
    ...
    Drink(id: UUID().uuidString, name: "Americano", imageName: "ice americano", category: Category.cold, description: "An Americano Coffee is an Espresso-based coffee drink with no special additions. It is simply a shot of Espresso with hot water poured in it. A well-prepared Americano has the subtle aroma and flavour like Espresso. It has a lighter body and less bitterness.", price: 2.00),
